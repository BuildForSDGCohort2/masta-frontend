        ...
        <div className="sidebar_innr" data-simplebar>
          <div className="sections">
            <ul>
              ...
              <li>
                <Link  to="/nearest-hospital" > <img src="assets/icons/other/location-hotel-svgrepo-com.svg" alt="" />
              ...
              <li>
                <Link to="/recipe" ><img src="assets/icons/other/health-care-diet-svgrepo-com.svg" alt="" />
                <span> Philia Recipe Engine </span>
                </Link>
              </li>
              <li>
